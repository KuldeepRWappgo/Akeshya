  ...
  return (
    <div className='section3-container'>
      <div className='section3-head'>
        ...
        <p className='section3-head-content'>ABOUT US</p>
        <div className='sec3-line'></div>
        </div>
      <div className='sec3-wrapper'>
        <div className='sec3-left'>
          ...
          <p className='sec3-para'>We started with a simple idea: do what is best for the client.</p>
          <p className='sec3-para'>
